...
unsigned int nTargetSpacing = 1 * 30; // ShitCoin - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // ShitCoin - time to elapse before new modifier is computed
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if(pindexBest->nHeight < 50000000)
     {
         nSubsidy = 0.1 * COIN;
     }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.bbc.co.uk/newsbeat/article/40429481/fast--furious-star-threatens-to-quit-due-to-poor-female-representation";
        CTransaction txNew;
        txNew.nTime = 1498679501;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1498679501;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 10782167;
        ...
        assert(block.hashMerkleRoot == uint256("2ae2395926cac66548e8d9f2126f84bd373af28839517eb1a9fb9b6c15cc6721"));
