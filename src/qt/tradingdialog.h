...
private slots:
    ...
    void on_BuyShitCoin_clicked();
    void on_SellShitCoinBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputShitCoin_textChanged(const QString &arg1);
    ...
    QString BuyShitCoin(QString OrderType, double Quantity, double Rate);
    QString SellShitCoin(QString OrderType, double Quantity, double Rate);
